...
capture = cv2.VideoCapture('downloads/lecexample000_5fps_fwd.mp4')
...
while(1):
	...
	cv2.imshow('frame2', cv2.hconcat([cv2.resize(frame2, resized_dim), cv2.resize(rgb_representation, resized_dim)]))
